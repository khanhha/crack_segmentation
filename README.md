...
|---|---|---|---|---|---|---|---|
| CFD (accessible, follow the license terms!)                    | 100      | 18    | 118    | segments | 480x320| Cui 2015, Shi 2016 | [CrackForest-dataset](https://github.com/cuilimeng/CrackForest-dataset)
| CRACK500 (?)              | 2,858    | 505   | 3,363  | segments | ~2,000x1,500| Yang 2019 | [CRACK500 (dataset not listed; probably the authors need to be contacted directly)](https://github.com/fyangneil/pavement-crack-detection) Here is a link to the data that must be followed
| DeepCrack (accessible, follow the license terms!)             | 443      | 78    | 521    | segments | 544x384 | Liu 2019  | [DeepCrack](https://github.com/yhlleo/DeepCrack) |
