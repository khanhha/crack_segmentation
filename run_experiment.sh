...
} 2>&1 | tee Experiment/CRACK500/test_results/Crack001First.log
...
{
    python evaluate_unet.py -ground_truth_dir ./CRACK500/test/masks -pred_dir ./Experiment/CRACK500/test_results/first
} 2>&1 | tee Experiment/CRACK500/test_results/Crack005First.log
sudo rm -r ./Experiment/CRACK500/model/first/*
...
{
    python evaluate_unet.py -ground_truth_dir ./CRACK500/test/masks -pred_dir ./Experiment/CRACK500/test_results/first
} 2>&1 | tee Experiment/CRACK500/test_results/Crack01First.log
sudo rm -r ./Experiment/CRACK500/model/first/*
...
{
    python evaluate_unet.py -ground_truth_dir ./CRACK500/test/masks -pred_dir ./Experiment/CRACK500/test_results/first
} 2>&1 | tee Experiment/CRACK500/test_results/Crack015First.log
sudo rm -r ./Experiment/CRACK500/model/first/*
...
{
    python evaluate_unet.py -ground_truth_dir ./CRACK500/test/masks -pred_dir ./Experiment/CRACK500/test_results/first
} 2>&1 | tee Experiment/CRACK500/test_results/Crack02First.log
sudo rm -r ./Experiment/CRACK500/model/first/*
...
{
    python evaluate_unet.py -ground_truth_dir ./CRACK500/test/masks -pred_dir ./Experiment/CRACK500/test_results/first
} 2>&1 | tee Experiment/CRACK500/test_results/Crack05First.log
sudo rm -r ./Experiment/CRACK500/model/first/*
...
{
    python evaluate_unet.py -ground_truth_dir ./CRACK500/test/masks -pred_dir ./Experiment/CRACK500/test_results/first
} 2>&1 | tee Experiment/CRACK500/test_results/Crack1First.log
sudo rm -r ./Experiment/CRACK500/model/first/*
...
{
    python evaluate_unet.py -ground_truth_dir ./CRACK500/test/masks -pred_dir ./Experiment/CRACK500/test_results/first
} 2>&1 | tee Experiment/CRACK500/test_results/Crack2First.log
sudo rm -r ./Experiment/CRACK500/model/first/*
...
{
    python evaluate_unet.py -ground_truth_dir ./CFD/test/masks -pred_dir ./Experiment/CFD/test_results/first
} 2>&1 | tee Experiment/CFD/test_results/CFD001First.log
...
{
    python evaluate_unet.py -ground_truth_dir ./CFD/test/masks -pred_dir ./Experiment/CFD/test_results/first
} 2>&1 | tee Experiment/CFD/test_results/CFD005First.log
sudo rm -r ./Experiment/CFD/model/first/*
...
{
    python evaluate_unet.py -ground_truth_dir ./CFD/test/masks -pred_dir ./Experiment/CFD/test_results/first
} 2>&1 | tee Experiment/CFD/test_results/CFD01First.log
sudo rm -r ./Experiment/CFD/model/first/*
...
{
    python evaluate_unet.py -ground_truth_dir ./CFD/test/masks -pred_dir ./Experiment/CFD/test_results/first
} 2>&1 | tee Experiment/CFD/test_results/CFD015First.log
sudo rm -r ./Experiment/CFD/model/first/*
...
{
    python evaluate_unet.py -ground_truth_dir ./CFD/test/masks -pred_dir ./Experiment/CFD/test_results/first
} 2>&1 | tee Experiment/CFD/test_results/CFD02First.log
sudo rm -r ./Experiment/CFD/model/first/*
...
{
    python evaluate_unet.py -ground_truth_dir ./CFD/test/masks -pred_dir ./Experiment/CFD/test_results/first
} 2>&1 | tee Experiment/CFD/test_results/CFD05First.log
sudo rm -r ./Experiment/CFD/model/first/*
...
{
    python evaluate_unet.py -ground_truth_dir ./CFD/test/masks -pred_dir ./Experiment/CFD/test_results/first
} 2>&1 | tee Experiment/CFD/test_results/CFD1First.log
sudo rm -r ./Experiment/CFD/model/first/*
...
{
    python evaluate_unet.py -ground_truth_dir ./CFD/test/masks -pred_dir ./Experiment/CFD/test_results/first
} 2>&1 | tee Experiment/CFD/test_results/CFD2First.log
sudo rm -r ./Experiment/CFD/model/first/*